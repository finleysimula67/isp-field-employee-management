...
public class EmployeeController {
    ...
    public ResponseEntity<ApiResponse<Page<EmployeeResponse>>> getAll(@PageableDefault(size = 50) Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.ok(employeeService.getAllEmployees(pageable)));
    }
