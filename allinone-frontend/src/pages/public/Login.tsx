  ...
  useEffect(() => {
    ...
    const warm = async () => {
      ...
      try {
        ...
        warmed = true
        setWarming(false)
        fetch(`${backendBase}/api/employees/me`, { signal: AbortSignal.timeout(5000) }).catch(() => {})
        fetch(`${backendBase}/api/branches`, { signal: AbortSignal.timeout(5000) }).catch(() => {})
      } catch {
